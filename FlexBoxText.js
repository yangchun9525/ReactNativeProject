...
export default class FlexBoxText extends Component{
    render(){
        ...
        <View style={ {borderColor:'red',borderWidth:10,backgroundColor:"darkgray",marginTop:20}}>
          <View style={ {flexDirection:'row',justifyContent:'flex-end',flexWrap:'wrap',backgroundColor:"darkgray",marginTop:20}}>
          ...
          <View style={ {flexDirection:'column-reverse',backgroundColor:"darkgray",marginTop:20,height:200,width:400}}>
